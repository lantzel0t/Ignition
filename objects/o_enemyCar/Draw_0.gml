...
if (vel > 1) {
	part_particles_create(global.PS_low, x + leftWheelX, y + leftWheelY, global.Part_dust, 6);
	part_particles_create(global.PS_low, x + rightWheelX, y + rightWheelY, global.Part_dust, 6);
}
